...
void main() {
  ...
  test('Content from multiple delegates of same identity should be merged and distincted', () async {
    ...
    await Future.delayed(Duration(milliseconds: 10));
    final ContentStatement s6 = await d2.doRate(subject: birds, recommend: true, comment: 'Flying things');
    ...
    final SubjectAggregation catsAgg = aggregation.subjects.values.firstWhere((SubjectAggregation s) => s.subject['title'] == 'Cats');
    ...
    final SubjectAggregation birdsAgg = aggregation.subjects.values.firstWhere((SubjectAggregation s) => s.subject['title'] == 'Birds');

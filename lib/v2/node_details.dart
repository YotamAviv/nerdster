...
class _NodeDetailsState extends State<NodeDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> delegates = labeler.delegateResolver?.getDelegatesForIdentity(widget.identity) ?? [];
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ...keys.map((k) {
              final isCanonical = k == widget.identity;
              return Builder(
                builder: (context) {
                  TapDownDetails? tapDetails;
                  return InkWell(
            ...
            if (_hasChanges) {
              final bool? shouldClose = await showDialog<bool>(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const Text('You have unsaved follow/block changes. Are you sure you want to discard them?'),
                  actions: [
                    TextButton(
  ...
  Widget _buildFollowContextsSection() {
    ...
    if (myId == widget.identity) return const Text("This is you.", style: TextStyle(fontStyle: FontStyle.italic));
      ...
      children: [
        ...
        if (_pendingContexts.isEmpty) 
          const Padding(
            ...
            child: Text('Not following in any context.', style: TextStyle(fontStyle: FontStyle.italic, color: Colors.grey, fontSize: 12)),
          ),

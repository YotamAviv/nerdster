...
Future<(DemoKey, DemoKey?)> egos() async {
  ...
  Jsonish h1 = await hipsterN.doRate(subject: {
    "contentType": "article",
  ...
  Jsonish h2 = await hipsterN.doRate(subject: {
    "contentType": "article",
    "title":
  ...
  Jsonish h3 = await hipsterN2.doRate(subject: {
    "contentType": "article",
    "title": "25+ Coolest Sleeve Tattoos for Men  | Man of Many",
    "url": "https://manofmany.com/entertainment/art/coolest-sleeve-tattoos"
  }, recommend: true);

  Jsonish h4 = await poserN.doRate(subject: h1.json, recommend: true, comment: 'Yeah, baby.');
  // Hipster likes and comments on poser's like of hipster's submission
  Jsonish h5 = await hipsterN2.doRate(subject: h4.json, recommend: true, comment: 'Thanks!');

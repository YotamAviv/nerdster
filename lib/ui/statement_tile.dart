...
import 'package:nerdster/ui/comment_widget.dart';
...
class StatementTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final myReplies = uniqueStatements.where((r) {
      if (!signInState.hasIdentity) return false;
      final myIdentityKey = signInState.identity;
          ...
          Row(
            children: [
              ...
              */
              ...
              CryptoShieldButton(json: s.json, labeler: model.labeler),
            ],
          ),

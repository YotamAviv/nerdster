...
class EquivalenceBridge {
  ...
  // TODO: Rename to chained and explain it. Is it this?: If I say A is related to B, but we also have A is actually AA, then we should be saying AA is related B.

...
void main() {
  ...
  testWidgets('Verify Corruption Detection', (WidgetTester tester) async {
    ...
    expect(contentSource.errors.isNotEmpty, isTrue, reason: "Expected Content Statement corruption notification");
    ...
    expect(trustSource.errors.isNotEmpty, isTrue, reason: "Expected Trust Statement corruption notification");
